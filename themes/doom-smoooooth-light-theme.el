;;; doom-smoooooth-light-theme.el --- inspired by Atom One Light -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-smoooooth-light-theme nil
  "Options for the `doom-smoooooth-light' theme."
  :group 'doom-themes)

(defcustom doom-smoooooth-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-smoooooth-light-theme
  :type 'boolean)

(defcustom doom-smoooooth-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-smoooooth-light-theme
  :type 'boolean)

(defcustom doom-smoooooth-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-smoooooth-light
  ...
  ((bg         '("#fafafa" "white"   "white"        ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-smoooooth-light-brighter-comments cyan base4))
   ...
   (modeline-fg-alt          (doom-blend
                              violet base4
                              (if doom-smoooooth-light-brighter-modeline 0.5 0.2)))
   (modeline-bg              (if doom-smoooooth-light-brighter-modeline
                                 (doom-darken base2 0.05)
                               base1))
   (modeline-bg-alt          (if doom-smoooooth-light-brighter-modeline
   ...
   (-modeline-pad
    (when doom-smoooooth-light-padded-modeline
      (if (integerp doom-smoooooth-light-padded-modeline) doom-smoooooth-light-padded-modeline 4))))
  ...
  (((font-lock-comment-face &override)
   ...
   (mode-line-emphasis
    :foreground (if doom-smoooooth-light-brighter-modeline base8 highlight))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if doom-smoooooth-light-brighter-modeline modeline-bg highlight))
   ;;;; ediff <built-in>
...
;;; doom-smoooooth-light-theme.el ends here
